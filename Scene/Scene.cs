...
namespace GraphicKurs
{
    ...
    public class Scene
    {
        ...
        public Table SelectedForPanObject = null;
        ...
        public List<Table> Objects { get; private set; } = new List<Table>();
        ...
        public void AddObject(Table obj)
        {
            Objects.Add(obj);
        }

        public Table GetObjectByName(string name)
        {
