...
namespace GraphicKurs
{
    public partial class MainForm : Form
    {
        ...
        public Table currentObject = null;
        ...
        {
            RightVolumeControllerStandRadius.Value = (decimal)currentObject.RightVolumeControllerStandRadius;
            RightVolumeControllerWidestPartRadius.Value = (decimal)currentObject.RightVolumeControllerWidestPartRadius;
            RightVolumeControllerStripeRadius.Value = (decimal)currentObject.RightVolumeControllerStripeRadius;
            LeftVolumeControllerStandRadius.Value = (decimal)currentObject.LeftVolumeControllerStandRadius;
            LeftVolumeControllerWidestPartRadius.Value = (decimal)currentObject.LeftVolumeControllerWidestPartRadius;
            LeftVolumeControllerStripeRadius.Value = (decimal)currentObject.LeftVolumeControllerStripeRadius;
            ControlButtonsHeight.Value = (decimal)currentObject.ControlButtonsHeight;
            ControlButtonsWidth.Value = (decimal)currentObject.ControlButtonsWidth;
            SphereCount.Value = currentObject.SphereCount;
            PlaybackButtonsCount.Value = currentObject.PlayBackButtonsCount;
        ...
        private void RightVolumeControllerStandRadius_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.RightVolumeControllerStandRadius)
            {
                currentObject.RightVolumeControllerStandRadius = value;
        ...
        private void ControlButtonsWidth_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.ControlButtonsWidth)
            {
                currentObject.ControlButtonsWidth = (double)ControlButtonsWidth.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void RightVolumeControllerWidestPartRadius_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.RightVolumeControllerWidestPartRadius)
            {
                currentObject.RightVolumeControllerWidestPartRadius = (double)RightVolumeControllerWidestPartRadius.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void RightVolumeControllerStripeRadius_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.RightVolumeControllerStripeRadius)
            {
                currentObject.RightVolumeControllerStripeRadius = (double)RightVolumeControllerStripeRadius.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void LeftVolumeControllerStandRadius_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.LeftVolumeControllerStandRadius)
            {
                currentObject.LeftVolumeControllerStandRadius = (double)LeftVolumeControllerStandRadius.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void LeftVolumeControllerWidestPartRadius_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.LeftVolumeControllerWidestPartRadius)
            {
                currentObject.LeftVolumeControllerWidestPartRadius = (double)LeftVolumeControllerWidestPartRadius.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void LeftVolumeControllerStripeRadius_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.LeftVolumeControllerStripeRadius)
            {
                currentObject.LeftVolumeControllerStripeRadius = (double)LeftVolumeControllerStripeRadius.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void ControlButtonsHeight_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.ControlButtonsHeight)
            {
                currentObject.ControlButtonsHeight = (double)ControlButtonsHeight.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void SphereCount_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.SphereCount)
            {
                currentObject.SphereCount = (int)SphereCount.Value;
                currentObject.UpdateObject();
            }
        }
        ...
        private void PlayBackButtonsCount_ValueChanged(object sender, EventArgs e)
        {
            ...
            if (value != currentObject.PlayBackButtonsCount)
            {
                currentObject.PlayBackButtonsCount = (int)PlaybackButtonsCount.Value;
                currentObject.UpdateObject();
            };
        }
        ...
        private void ExportScene_Click(object sender, EventArgs e)
        {
            if (ExportDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    foreach (Table radio in Scene.Objects)
                    {
                        XElement objectelement;

                        objectelement = new XElement("Radio");

                        objectelement.SetElementValue("RightVolumeControllerStandRadius", string.Format(format, "{0:0.00}", radio.RightVolumeControllerStandRadius));
                        objectelement.SetElementValue("RightVolumeControllerWidestPartRadius", string.Format(format, "{0:0.00}", radio.RightVolumeControllerWidestPartRadius));
                        objectelement.SetElementValue("RightVolumeControllerStripeRadius", string.Format(format, "{0:0.00}", radio.RightVolumeControllerStripeRadius));
                        objectelement.SetElementValue("LeftVolumeControllerStandRadius", string.Format(format, "{0:0.00}", radio.LeftVolumeControllerStandRadius));
                        objectelement.SetElementValue("LeftVolumeControllerWidestPartRadius", string.Format(format, "{0:0.00}", radio.LeftVolumeControllerWidestPartRadius));
                        objectelement.SetElementValue("LeftVolumeControllerStripeRadius", string.Format(format, "{0:0.00}", radio.LeftVolumeControllerStripeRadius));
                        objectelement.SetElementValue("ControlButtonsHeight", string.Format(format, "{0:0.00}", radio.ControlButtonsHeight));
                        objectelement.SetElementValue("ControlButtonsWidth", string.Format(format, "{0:0.00}", radio.ControlButtonsWidth));
                        objectelement.SetElementValue("SphereCount", radio.SphereCount);
                        objectelement.SetElementValue("PlayBackButtonsCount", radio.PlayBackButtonsCount);
            ...
            if (ImportDialog.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    foreach (XElement objectElement in scene.Element("objects").Elements("Radio"))
                    {
                        ...
                        radio.RightVolumeControllerStandRadius = double.Parse(objectElement.Element("RightVolumeControllerStandRadius").Value, format);
                        radio.RightVolumeControllerWidestPartRadius = double.Parse(objectElement.Element("RightVolumeControllerWidestPartRadius").Value, format);
                        radio.RightVolumeControllerStripeRadius = double.Parse(objectElement.Element("RightVolumeControllerStripeRadius").Value, format);
                        radio.LeftVolumeControllerStandRadius = double.Parse(objectElement.Element("LeftVolumeControllerStandRadius").Value, format);
                        radio.LeftVolumeControllerWidestPartRadius = double.Parse(objectElement.Element("LeftVolumeControllerWidestPartRadius").Value, format);
                        radio.LeftVolumeControllerStripeRadius = double.Parse(objectElement.Element("LeftVolumeControllerStripeRadius").Value, format);
                        radio.ControlButtonsHeight = double.Parse(objectElement.Element("ControlButtonsHeight").Value, format);
                        radio.ControlButtonsWidth = double.Parse(objectElement.Element("ControlButtonsWidth").Value, format);
                        radio.SphereCount = int.Parse(objectElement.Element("SphereCount").Value, format);
                        radio.PlayBackButtonsCount = int.Parse(objectElement.Element("PlayBackButtonsCount").Value, format);
